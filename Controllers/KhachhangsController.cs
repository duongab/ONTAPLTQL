...
namespace ONTAPLTQL.Controllers
{
    public class KhachhangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "makh,tenkh,sdt,email")] Khachhang khachhang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "makh,tenkh,sdt,email")] Khachhang khachhang)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult UploadFile(HttpPostedFileBase file)
        {
            try
            {
                ...
                {
                    //Your code
                    string _FileName = "khachhang1.xlsx";
                    //duong dan luu file
        ...
        private void CopyDataByBulk(DataTable dt)
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["OTLTQLDbContext"].ConnectionString);
            SqlBulkCopy bulkcopy = new SqlBulkCopy(con);
            con.Open();
            bulkcopy.DestinationTableName = "Khachhangs";
            bulkcopy.ColumnMappings.Add(0, "makh");
            bulkcopy.ColumnMappings.Add(1, "tenkh");
            bulkcopy.ColumnMappings.Add(2, "sdt");
        ...
        public ActionResult DownloadFile()
        {
            ...
            byte[] fileBytes = System.IO.File.ReadAllBytes(path + "khachhang1.xlsx");
            //ten file khi download ve
            string fileName = "khachhang1.xlsx";
            //tra ve file
